...
export const articleItems = [
  {
    ...
    content: `### 【開催レポート】参加者4000人突破記念！「The streamer Creator server APEXカスタム 予選」2日間の激闘をプレイバック！
2026年5月23日（土）・24日（日）の2日間にわたり、配信者やクリエイターが集う大人気Discordサーバー「The streamer Creator server」の参加者4000人突破を記念した**APEXカスタム予選（Aブロック・Bブロック）**が開催されました！
3000人記念大会からさらに拡大し、今回は2日間で**合計40チーム・120名の配信者**が参戦！ 8月29日（土）に行われる「本戦」への切符（各ブロック上位10チーム・計20チーム）をかけた、熱すぎる予選の模様をレポートします！
---
### 🎬 2日間連続の豪華演出！
今回の予選は、なんとAブロックとBブロックで**異なるオリジナル映像を用意！**
...
*   **19キル＆17キル！怒涛の2連チャン**
    第一試合・第二試合では、リーダー「もの」氏率いる「ファイトマシマシ～ダウン多め、コール少なめ」が圧倒的なガンファイトを展開！第一試合で19キル、第二試合で17キルという破格のキル数を叩き出し、**圧巻の2連続チャンピオン**を獲得しました。
*   **武器禁止！“拳”で制した肉弾戦**
    特殊ルール（武器禁止マッチ）となった第四試合・第五試合では、リーダー「あるーるん」氏率いる「あるある探検隊～頂をいただきに来た漢達～」が熱い殴り合いを制して**2連続チャンピオン**を獲得！
...
*   **ぶるちゃっぴー氏の凄腕4タテ！**
    第二試合・第三試合では、リーダー「こゆびさま」氏率いる「ぶるちゃっぽんさま2」が2連続チャンピオンを獲得！特にぶるちゃっぴー氏がダブルタップオルタネーターで魅せた**華麗な「4タテ」**には、コメント欄も大歓喜となりました。
*   **怒涛の追撃を見せた社会人チーム**
...
アクシ寄ントを乗り越え、チームメンバー同士の絆と熱量がさらに深まった素晴らしい2日間となりました。参加された選手の皆様、長時間の配信を見守った視聴者の皆様、本当にお疲れ様でした！
